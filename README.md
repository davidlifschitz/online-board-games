...
**24 live games · 51 build prompts · 28 prompt concepts waiting for a first deployment**
...
**23 of the 51 numbered prompt concepts have a live implementation.** Deal Room is an additional deployed game outside the numbered prompt catalog.

## 2026-08-19 conversion Batch 1

Five concepts that were unbuilt at the start of this pass are now production routes: **Mergefront, Boxline, Sowstone, Cipherloom, and Spark Six**. Every Batch 1 game includes offline caching, local-state resume, rules tests, and `THIRD_PARTY_NOTICES.md`. Source selection is documented in [`SOURCE_RESEARCH_BATCH_1.md`](SOURCE_RESEARCH_BATCH_1.md).

## 2026-08-19 conversion Batch 2

Five more concepts are production-verified: **Millstone, Hexline, Racehome, Gridwake, and Twenty-One Lab**. Their engines cover Morris mill/flying rules, Hex connection/pie rule, complete-turn Backgammon legality, hidden-fleet commitments, and configurable play-money Blackjack training. Research is documented in [`SOURCE_RESEARCH_BATCH_2.md`](SOURCE_RESEARCH_BATCH_2.md).

## 2026-08-19 conversion Batch 3

Five classic card-game concepts are now production-verified:
...
- **Gin Rummy** — optimal meld partitioning, draw/discard restrictions, knock/gin/layoff/undercut scoring, standard stock-to-two cancelled hands, and bot play.
- **Rummy 500** — 2–6 seats, standard 13-card two-player deal, visible discard-stack pickups, buried-card meld obligation, top-card re-discard restriction, meld/layoff scoring, and bots.

All selected Batch 3 references were directly license-checked as MIT and are used only as audited/reference baselines; no upstream code or artwork was copied. [`SOURCE_RESEARCH_BATCH_3.md`](SOURCE_RESEARCH_BATCH_3.md) also records excluded GPL/unlicensed candidates.
...
- [`play.html`](play.html) — renders the live arcade from `games.json`.
